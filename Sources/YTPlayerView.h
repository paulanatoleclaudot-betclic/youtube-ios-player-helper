 ...
 */
- (BOOL)loadWithVideoId:(nonnull NSString *)videoId andiFramePath:(NSString *_Nullable)path;
 ...
 * @return YES if player has been configured correctly, NO otherwise.
 */
- (BOOL)loadWithPlaylistId:(nonnull NSString *)playlistId andiFramePath:(NSString *_Nullable)path;
 ...
 * @return YES if player has been configured correctly, NO otherwise.
 */
- (BOOL)loadWithVideoId:(nonnull NSString *)videoId playerVars:(nullable NSDictionary *)playerVars andiFramePath:(NSString *_Nullable)path;
...
- (BOOL)loadWithPlaylistId:(nonnull NSString *)playlistId
                playerVars:(nullable NSDictionary *)playerVars andiFramePath:(NSString *_Nullable)path;
 ...
 */
- (BOOL)loadWithPlayerParams:(nullable NSDictionary *)additionalPlayerParams andiFramePath:(NSString *_Nullable)path;
