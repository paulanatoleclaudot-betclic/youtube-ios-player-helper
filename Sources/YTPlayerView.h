 ...
 */
- (BOOL)loadWithVideoId:(nonnull NSString *)videoId andiFramePath:(NSString *_Nonnull)path;
 ...
 * @return YES if player has been configured correctly, NO otherwise.
 */
- (BOOL)loadWithPlaylistId:(nonnull NSString *)playlistId andiFramePath:(NSString *_Nonnull)path;
 ...
 * @return YES if player has been configured correctly, NO otherwise.
 */
- (BOOL)loadWithVideoId:(nonnull NSString *)videoId playerVars:(nullable NSDictionary *)playerVars andiFramePath:(NSString *_Nonnull)path;
...
- (BOOL)loadWithPlaylistId:(nonnull NSString *)playlistId
                playerVars:(nullable NSDictionary *)playerVars andiFramePath:(NSString *_Nonnull)path;
 ...
 */
- (BOOL)loadWithPlayerParams:(nullable NSDictionary *)additionalPlayerParams andiFramePath:(NSString *_Nonnull)path;
